  ...
  <el-container class="home-container">
    <el-header class="firstheader">
      ...
      >
        ...
        <el-menu-item index="2" :style="{height:'59px'}" @click="">
          <i class="el-icon-menu"></i>贷款项目待审核公司档案
        </el-menu-item>
        <el-menu-item index="1=3" :style="{height:'59px'}" @click="">
          <i class="el-icon-menu"></i>建立贷款档案
        </el-menu-item>
        <el-menu-item index="4" :style="{height:'59px'}" @click="">
          <i class="el-icon-menu"></i>查看贷款公司档案
        </el-menu-item>
    ...
    <el-container class="home-container">
      <el-main class="firstmain">
        <h1 style="height: 100px;margin-top: 75px;text-align: center">贷款项目信息</h1>
        <div class="Timelocation">
          <el-timeline>
            <el-timeline-item  :timestamp="dataproject.updateTime" placement="top" v-for="dataproject in dataproject">
              <el-card>
                <h4>项目名称</h4>
              ...
              <el-card>
                <h4>项目简介</h4>
                <p>{{dataproject.projectIntroduction}}</p>
              </el-card>
              <el-card>
                <h4>开始时间</h4>
                <p>{{dataproject.projectStartTime}}</p>
              </el-card>
              <el-card>
                <h4>项目所用金额</h4>
                <p>{{dataproject.projectCost}}</p>
              </el-card>
              <el-card>
                <h4>项目评价</h4>
                <p>{{dataproject.projectComment}}</p>
              </el-card>
              <el-card>
                <h4>项目其他备注</h4>
                <p>{{dataproject.projectRemark}}</p>
              </el-card>
            </el-timeline-item >
          </el-timeline>
        </div>
